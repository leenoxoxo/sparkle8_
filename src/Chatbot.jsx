...
export function answerQuestion(question, { products, workshops, kits, t, arabic }) {
  ...
  if (/product|shop|available|منتج|متجر|متوفر/.test(q)) return reply(say('Explore our handmade phone cases, mirrors, brushes, combs, and fake cake boxes. Send the product name to ask about its listed details.', 'استكشفي أغطية الهواتف والمرايا والفُرش والأمشاط وعلب الكيك الوهمي المصنوعة يدوياً. أرسلي اسم المنتج للسؤال عن تفاصيله.'), '/shop');
